...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)},o.exports.default=o.exports,o.exports.__esModule=!0},3:function(o,f){o.exports=function(t,a){return a||(a=t.slice(0)),Object.freeze(Object.defineProperties(t,{raw:{value:Object.freeze(a)}}))},o.exports.default=o.exports,o.exports.__esModule=!0},4:function(o,f,t){var a=t(24);o.exports=function(i,d){if(i==null)return{};var s,r,u=a(i,d);if(Object.getOwnPropertySymbols){var m=Object.getOwnPropertySymbols(i);for(r=0;r<m.length;r++)s=m[r],d.indexOf(s)>=0||Object.prototype.propertyIsEnumerable.call(i,s)&&(u[s]=i[s])}return u},o.exports.default=o.exports,o.exports.__esModule=!0},47:function(o,f,t){"use strict";t.r(f),t.d(f,"Grid",function(){return z}),t.d(f,"GridItem",function(){return P});var a,i=t(5),d=t.n(i),s=t(4),r=t.n(s),u=t(3),m=t.n(u),l=t(1),y=t.n(l),p=t(2),n=t.n(p),e=t(0),c=t.n(e),x=Object(l.createContext)({gap:0,gridCols:12}),O=t(6),W=t(7),T=["gap","gridCols"],F=n()(O.Box)(a||(a=m()([`
  ...
  `,`
`])),function(h){return h.gridCols},function(h){var j=h.theme,w=h.gap;return Object(W.a)("gap",w,j)}),z=function(h){var j=h.gap,w=h.gridCols,L=r()(h,T);return y.a.createElement(x.Provider,{value:{gap:j,gridCols:w}},y.a.createElement(F,d()({gap:j,gridCols:w},L)))};z.defaultProps={gap:0,gridCols:12},z.propTypes={gap:c.a.oneOfType([c.a.number,c.a.arrayOf(c.a.number)]),gridCols:c.a.number};var R,N=["col","xs","s"],q=n.a.div(R||(R=m()([`
  grid-column: span `,`;
  max-width: 100%;
...
`])),function(g){return g.theme.spaces[2]},function(g){return g.pullRight?"auto":void 0}),z=p()(F)(W||(W=s()([`
  flex-shrink: 0;
`]))),R=function(g){var v=g.startActions,b=g.endActions;return v||b?u.a.createElement(n.Box,{paddingLeft:10,paddingRight:10},u.a.createElement(n.Box,{paddingBottom:4},u.a.createElement(T.Flex,{justifyContent:"space-between",alignItems:"flex-start"},v&&u.a.createElement(F,{wrap:"wrap"},v),b&&u.a.createElement(z,{pullRight:!0},b)))):null};R.defaultProps={endActions:void 0,startActions:void 0},R.propTypes={endActions:l.a.node,startActions:l.a.node};var N=function(g){var v=g.children;return u.a.createElement(n.Box,{paddingLeft:10,paddingRight:10},v)};N.propTypes={children:l.a.node.isRequired};var q,P=t(4),h=t.n(P),j=t(5),w=t.n(j),L=t(10),A=t.n(L),C=t(8),Y=t(48),$=["navigationAction","primaryAction","secondaryAction","subtitle","title","sticky","width"],an=function(){var g=Object(r.useRef)(null),v=Object(r.useState)(null),b=A()(v,2),E=b[0],S=b[1],_=function(M){var Q=Object(r.useRef)(null),sn=Object(r.useState)(!0),rn=A()(sn,2),cn=rn[0],dn=rn[1],ln=function(D){var U=A()(D,1)[0];dn(U.isIntersecting)};return Object(r.useEffect)(function(){var D=Q.current,U=new IntersectionObserver(ln,M);return D&&U.observe(Q.current),function(){D&&U.disconnect()}},[Q,M]),[Q,cn]}({root:null,rootMargin:"0px",threshold:0}),H=A()(_,2),k=H[0],K=H[1];return Object(Y.a)(k,function(){k.current&&S(k.current.getBoundingClientRect())}),Object(r.useEffect)(function(){g.current&&S(g.current.getBoundingClientRect())},[g]),{containerRef:k,isVisible:K,baseHeaderLayoutRef:g,headerSize:E}},G=function(g){var v=an(),b=v.containerRef,E=v.isVisible,S=v.baseHeaderLayoutRef,_=v.headerSize;return u.a.createElement(u.a.Fragment,null,u.a.createElement("div",{style:{height:_==null?void 0:_.height},ref:b},E&&u.a.createElement(B,w()({ref:S},g))),!E&&u.a.createElement(B,w()({},g,{sticky:!0,width:_==null?void 0:_.width})))};G.displayName="HeaderLayout";var un=p()(n.Box)(q||(q=s()([`
  position: fixed;
  top: 0;
  right: 0;
  width: `,`px;
